...
const BASE_URL = 'http://localhost:5041/api/Usuario'; // Asegúrate de que esta URL sea correcta
...
export const validarCredenciales = async (correo, contrasenna) => {
    try {
        ...
        const response = await axios.post(`${BASE_URL}/validar-credenciales`, credencialesDTO);
